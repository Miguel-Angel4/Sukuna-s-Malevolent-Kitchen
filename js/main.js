...
// --- L�gica del Widget de Calendario (Reserva) ---
document.addEventListener('DOMContentLoaded', () => {
...
// --- L�gica extendida del Calendario Mensual ---
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateTables(day) {
        ...
        statusTitle.textContent = Estado para el d�a  + day;

        // Generar 15 mesas con estados pseudo-aleatorios basados en el d�a
        for (let i = 1; i <= 15; i++) {
            const isReserved = (Math.sin(day * i) > 0.3); // Algoritmo simple para variar ocupaci�n
